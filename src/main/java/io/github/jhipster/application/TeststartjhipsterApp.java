...
public class TeststartjhipsterApp {

    private static final Logger log = LoggerFactory.getLogger(TeststartjhipsterApp.class);

    private final Environment env;

    public TeststartjhipsterApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes teststartjhipster.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TeststartjhipsterApp.class);
